...
- [x] 2026-07-17 HOME の GitHub 機能を削除: 「GitHub」（TODO サマリー）と「昨日の GitHub」の 2 セクションを HOME から削除（GitHub タブに集約済みのため）。未使用になった todoRepoSummaries / githubSummary ヘルパーも削除し、ios-app-screens.md の HOME 記述を更新。backend・payload は不変。シミュレータビルドで検証済み [plan](docs/plans/archive/remove-home-github-sections.md)
